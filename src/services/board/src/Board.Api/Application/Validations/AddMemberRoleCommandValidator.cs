...
{
    public class AddMemberRoleCommandValidator : ACommandValidator<AddMemberRoleCommand>
    {
        public AddMemberRoleCommandValidator(ILogger<AddMemberRoleCommandValidator> logger)
        {
