  ...
  return (
    <section className="login-container">
      ...
      <div className="login-container__right">
        <div className="login-container__right-bg">
          <div className="absolute bg-black opacity-60 inset-0 z-0" />
        </div>
        <div className="w-full py-6 z-20">
          <h1 className="my-6 text-3xl font-semibold">Log in</h1>
          <form
          ...
          >
            ...
            <div className="py-4 text-left">
              ...
              />
              {errors.email && (
                <strong className="text-red-500 text-xs block pt-2">
            ...
            <div className="pb-2 flex items-center justify-between">
              ...
              <Link to="/signup" className="text-xs text-white uppercase">
                or sign up
              </Link>
              <span className="border-b w-1/5 md:w-1/4" />
            </div>
